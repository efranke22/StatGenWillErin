...
The first step of this is to shown how to run a GWAS in PLINK. Unlike in the example shown using RStudio, we will actually generate a trait of interest based off a particular causal SNP for this example GWAS.
...
We can then go back to our original GWAS and see which SNPs have p-values below this threshold of $3.39 \times 10^{-8}$.
