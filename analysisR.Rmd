...
If you for some reason decided to run the code in Step 3, you could run the following code chunk to get the threshold for the family wise error rate of 5%. This is the significance threshold! The threshold we got after 21 days was $7.83 \times 10^{-8}$.
